...
import rcs from '../../assets/pictures/rcs.png';
import rib from '../../assets/pictures/RIB.jpg';
import police from '../../assets/pictures/police.jpeg';
import interpol from '../../assets/pictures/interpol.jpg';
import unodc from '../../assets/pictures/UNODC.jpeg';
import minijust from '../../assets/pictures/justice.jpg';

const Partners = () => {
  const partners = [
    { name: "RNP", url: "https://www.police.gov.rw/", image: police },
    { name: "RCS", url: "http://rcs.gov.rw", image: rcs },
    { name: "UNODC", url: "https://www.unodc.org", image: unodc },
    { name: "RIB", url: "https://www.rib.gov.rw/", image: rib },
    { name: "INTERPOL", url: "https://www.interpol.int/", image: interpol },
                ...
                >
                  <div className="flex flex-col items-center">
                    ...
                    <div 
                      ...
                      className="flex items-center space-x-2 text-blue-600 hover:text-blue-800 cursor-pointer group/link"
                    >
